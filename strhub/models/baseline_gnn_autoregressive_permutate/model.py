...
class GNN_AR_Model(nn.Module):
    def __init__(
        ...
        **gnn_kwargs
        ...
        # Assuming 43 joints (from input_dim=86 which is 43*2)
    ...
    def encode(self, poses):
        ...
        # [B, T, J*gnn_feature_dim]
        frame_features = joint_features.reshape(B, T, -1)
        
        # Project to transformer dimension
        frame_features = self.gnn_proj(frame_features)
        ...
        x = self.temporal_pooling(x)  # [B, conv_channels, T/4]
