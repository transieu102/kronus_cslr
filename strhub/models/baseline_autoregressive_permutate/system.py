...
from .model import CSLRTransformerAutoregressivePermutate
import numpy as np
from torch import Tensor
from itertools import permutations
from typing import Any, Optional, Sequence
from pytorch_lightning.utilities.types import STEP_OUTPUT
class CSLRAutoregressiveSystemPermutate(CrossEntropySystem):
    def __init__(self, tokenizer, config):
        ...
        self.model = CSLRTransformerAutoregressivePermutate(
            input_dim=input_dim,
