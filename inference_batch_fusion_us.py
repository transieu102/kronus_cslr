...
def main():
    pose_pkl = "test_data/US/pose_data_isharah1000_US_test.pkl"
    test_csv = "test_data/US/test.txt"  # file chỉ có cột id
    checkpoint_folder = "/home/sieut/kronus/logsus/RegionGNNCSLRSystemCTC2Phase/"
