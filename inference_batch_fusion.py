...
def main():
    pose_pkl = "test_data/SI/pose_data_isharah1000_SI_test.pkl"
    test_csv = "test_data/SI/test.txt"  # file chỉ có cột id
    ...
    checkpoint_paths = [
        "/home/sieut/kronus/logs/MultiRegionCSLRSystemVersion2/runs_20250622_075948/version_0/checkpoints/epoch=113-val_loss=val_loss=0.2171-val_wer=val_wer=3.0926.ckpt",
        "/home/sieut/kronus/logs/MultiRegionCSLRSystemVersion2/runs_20250622_075948/version_0/checkpoints/last.ckpt",
        "/home/sieut/kronus/logs/MultiRegionCSLRSystemVersion2/runs_20250622_175331/version_0/checkpoints/epoch=169-val_loss=val_loss=0.2038-val_wer=val_wer=2.6543.ckpt",
        "/home/sieut/kronus/logs/MultiRegionCSLRSystemVersion2/runs_20250622_175331/version_0/checkpoints/last.ckpt",
        "/home/sieut/kronus/logs/MultiRegionCSLRSystemVersion2/runs_20250623_013742/version_0/checkpoints/epoch=103-val_loss=val_loss=0.2323-val_wer=val_wer=3.8442.ckpt",
        "/home/sieut/kronus/logs/MultiRegionCSLRSystemVersion2/runs_20250623_013742/version_0/checkpoints/last.ckpt",
        "/home/sieut/kronus/logs/MultiRegionCSLRSystemVersion2/runs_20250623_174942/version_0/checkpoints/epoch=153-val_loss=val_loss=0.2017-val_wer=val_wer=2.5779.ckpt",
        "/home/sieut/kronus/logs/MultiRegionCSLRSystemVersion2/runs_20250623_174942/version_0/checkpoints/last.ckpt"
    ]
    ...
    #     checkpoint_path_dir = os.path.join(checkpoint_folder, run_folder,"version_0", "checkpoints")
    #     for checkpoint_path in os.listdir(checkpoint_path_dir):
    #         if checkpoint_path.endswith(".ckpt"):
    #             checkpoint_paths.append(os.path.join(checkpoint_path_dir, checkpoint_path))
        ...
        for batch in tqdm(test_loader):
            ...
            for system in systems:
                ...
                if logits_total is None:
                    ...
                    # logits_total += logits
                    logits_total = torch.max(logits_total, logits)
